...
public class BaseDriverUtil {
	...
	public static WebDriver getDriver() {
		String driverType = BaseConfiguration.getDriverType();
		System.setProperty(driverType, BaseConfiguration.getDriverPath());
		if (driverType.equals("webdriver.gecko.driver")) {
			driver = new FirefoxDriver();
		} else if (driverType.equals("webdriver.chrome.driver")) {
			driver = new ChromeDriver();
		} else {

		}
		// driver = new HtmlmaterialDriver();
		driver.manage().timeouts().implicitlyWait(Integer.parseInt(BaseConfiguration.getValue("implicitlyWait")),
				TimeUnit.SECONDS);
		return driver;
	}
	
	public static void loginSite(){
		baseUrl = BaseConfiguration.getBaseUrl();
		loginUrl = BaseConfiguration.getLoginUrl();
        username=BaseConfiguration.getValue("username");
        password=BaseConfiguration.getValue("password");
		driver.get(loginUrl + "/login?goto=" + baseUrl + "/homePage");
